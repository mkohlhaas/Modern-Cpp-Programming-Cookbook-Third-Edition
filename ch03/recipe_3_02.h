...
namespace recipe_3_02
{
    ...
    class range_selector
    {
      ...
      public:
        explicit range_selector(int const minimum, int const maximum) : minimum_(minimum), maximum_(maximum)
        {
        }

        bool
        operator()(int const n)
        {
    ...
    class __lambda_name_2__
    {
      ...
      public:
        explicit __lambda_name_2__(int const minimum, int const maximum) : minimum_(minimum), maximum_(maximum)
        {
        }
    ...
    execute()
    {
...

        {
            ...
            auto maximum{10};
            auto inrange = std::count_if(std::begin(numbers), std::end(numbers), range_selector(minimum, maximum));
...
#ifdef HAS_CPP23_LAMBDA_ATTRIBUTES
        {
