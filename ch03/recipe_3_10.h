...
namespace recipe_3_10
{
    int
    add(int const a, int const b)
    {
        return a + b;
    }
    ...
    namespace details
    {
        ...
        auto
        apply(F &&f, T &&t, std::index_sequence<I...>)
        {
    ...
    execute()
    {
...

        {
            ...
            auto a = recipe_3_10::apply(add, std::make_tuple(1, 2));
        }
    }
} // namespace recipe_3_10