...
struct global_fixture
{
    ...
    ~global_fixture()
    {
        BOOST_TEST_MESSAGE("global cleanup");
    }
...
BOOST_AUTO_TEST_CASE(test_case_funcfix, *boost::unit_test::fixture(&fixture_setup, &fixture_cleanup))
{
    BOOST_TEST(true);
}
