...
namespace recipe_4_04
{
    template <typename T>
    void
    func([[maybe_unused]] typename T::value_type const a)
    {
        std::cout << "func<>" << '\n';
    }
    void
    func([[maybe_unused]] int const a)
    {
        std::cout << "func" << '\n';
    }
    ...
    execute()
    {
...

        {
            ...
            //[[maybe_unused]] pod_wrapper2<std::string> w3; // error
            //[[maybe_unused]] pod_wrapper2<foo> w4; // error
        }
