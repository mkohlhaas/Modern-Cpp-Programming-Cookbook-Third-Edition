...
namespace recipe_5_01
{
    ...
    void
    process(int const *const arr, size_t const size)
    {
    ...
    execute()
    {
...

        {
            ...
            v8.erase(std::remove_if(v8.begin(), v8.end(), [](const int n) { return n % 2 == 0; }), v8.end());

            std::vector<int> v9{1, 2, 3, 4, 5};
            auto             erased = std::erase_if(v9, [](const int n) { return n % 2 == 0; });
        }
