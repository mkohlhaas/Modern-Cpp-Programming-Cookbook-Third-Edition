...
namespace recipe_5_05
{
    ...
    execute()
    {
...

        {
            ...
            if (it != v1.cend())
            {
                std::cout << "found at index " << std::distance(v1.cbegin(), it) << '\n';
            }
        }
...

        {
            ...
            auto it =
                std::search(text.cbegin(), text.cend(), std::make_boyer_moore_searcher(word.cbegin(), word.cend()));
...

        {
            ...
            if (it != v.cend())
            {
                std::cout << "lower bound at " << std::distance(v.cbegin(), it) << '\n';
            }
        }

        {
            ...
            if (it != v.cend())
            {
                std::cout << "upper bound at " << std::distance(v.cbegin(), it) << '\n';
            }
        }

        {
            ...
            std::cout << "range between indexes " << std::distance(v.cbegin(), bounds.first) << " and "
