...
namespace recipe_7_05
{
    ...
    print1()
    {
        ...
        for (auto const &company : companies)
        {
            ...
            std::cout << std::left << std::setw(5) << std::setfill(' ') << std::boolalpha << company.RevenueIncrease
                      << std::noboolalpha;
            std::cout << std::right << std::setw(5) << std::setfill(' ') << std::fixed << std::setprecision(1)
                      << company.Growth << std::defaultfloat << std::setprecision(6) << ' ';
    ...
    to_roman(unsigned int value)
    {
        ...
        const static roman_t rarr[13] = {{1000, "M"}, {900, "CM"}, {500, "D"}, {400, "CD"}, {100, "C"},
