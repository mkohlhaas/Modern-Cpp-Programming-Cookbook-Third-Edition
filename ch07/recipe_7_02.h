...
namespace recipe_7_02
{
    ...
    class foo
    {
      ...
      public:
        ...
        bool
        write(std::ofstream &ofile) const
        {
    ...
    std::ofstream &
    operator<<(std::ofstream &ofile, foo const &f)
    {
    ...
    std::ifstream &
    operator>>(std::ifstream &ifile, foo &f)
    {
    ...
    bool
    operator==(foopod const &f1, foopod const &f2)
    {
