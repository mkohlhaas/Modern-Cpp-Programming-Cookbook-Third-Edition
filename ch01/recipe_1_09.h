...
namespace recipe_1_09
{
    ...
    class dummy_array
    {
      ...
      public:
        T const &
        GetAt(size_t const index) const
        {
            if (index < Size)
            {
                return data[index];
        ...
        void
        SetAt(size_t const index, T const &value)
        {
            if (index < Size)
            {
                data[index] = value;
    ...
    class dummy_array_iterator_type
    {
      public:
        ...
        bool
        operator!=(dummy_array_iterator_type const &other) const
        {
    ...
    template <typename T, size_t const Size>
    inline dummy_array_iterator<T, Size>
    begin(dummy_array<T, Size> &collection)
    {
    ...
    template <typename T, size_t const Size>
    inline dummy_array_iterator<T, Size>
    end(dummy_array<T, Size> &collection)
    {
        return dummy_array_iterator<T, Size>(collection, collection.GetSize());
    }

    template <typename T, size_t const Size>
    inline dummy_array_const_iterator<T, Size>
    begin(dummy_array<T, Size> const &collection)
    {
    ...
    template <typename T, size_t const Size>
    inline dummy_array_const_iterator<T, Size>
    end(dummy_array<T, Size> const &collection)
    {
    ...
    void
    print_dummy_array(dummy_array<T, Size> const &arr)
    {
        for (auto &&e : arr)
        {
            std::cout << e << '\n';
