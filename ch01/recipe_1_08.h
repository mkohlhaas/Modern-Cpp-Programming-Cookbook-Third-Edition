...
namespace recipe_1_08
{
    ...
    inline void
    print_rate(int const rate)
    {
        std::cout << rate << '\n';
    }

    inline std::multimap<int, bool>
    getRates2()
    {
        return std::multimap<int, bool>{{1, true}, {1, true}, {2, false}, {3, true}, {5, true}, {8, false}, {13, true}};
    }
