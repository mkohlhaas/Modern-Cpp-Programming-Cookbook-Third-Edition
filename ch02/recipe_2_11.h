...
namespace recipe_2_11
{
    namespace string_library
    {
        ...
        template <typename CharT>
        inline tstring<CharT>
        remove(tstring<CharT> text, CharT const ch)
        {
    ...
    execute()
    {
        ...
        std::string s1 = "this is not UPPERCASE";
        auto        us1{string_library::to_upper(s1)};
