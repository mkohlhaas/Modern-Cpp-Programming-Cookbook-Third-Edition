...
namespace std
{
    ...
    __str_rfind(const _CharT *__p, _SizeT __sz, const _CharT *__s, _SizeT __pos, _SizeT __n) _NOEXCEPT
    {
        ...
        const _CharT *__r = _VSTD::__find_end(__p, __p + __pos, __s, __s + __n, _Traits::eq,
        ...
        inline namespace fundamentals_v1
        {
            ...
            class basic_string_view
            {
              public:
                ...
                inline basic_string_view(const basic_string<_CharT, _Traits, _Allocator> &__str) _NOEXCEPT
                    : __data(__str.data()),
                      __size(__str.size())
                {
                }

                constexpr inline basic_string_view(const _CharT *__s, size_type __len) : __data(__s), __size(__len)
                {
                    //             _LIBCPP_ASSERT(__len == 0 || __s != nullptr, "string_view::string_view(_CharT *,
                    //             size_t): received nullptr");
                }

                constexpr inline basic_string_view(const _CharT *__s) : __data(__s), __size(_Traits::length(__s))
                {
                }
                ...
                constexpr inline const_reference
                ...
                {
                    return __pos >= size() ? (__throw_out_of_range("string_view::at"), __data[0]) : __data[__pos];
                }
                ...
                constexpr inline const_pointer
                ...
                constexpr int
                compare(basic_string_view __sv) const _NOEXCEPT
                {
                ...
                find(basic_string_view __s, size_type __pos = 0) const _NOEXCEPT
                {
                    ...
                    return std::__str_find<value_type, size_type, traits_type, npos>(data(), size(), __s.data(), __pos,
                                                                                     __s.size());
                }
                ...
                find(const _CharT *__s, size_type __pos = 0) const
                {
                    ...
                    return std::__str_find<value_type, size_type, traits_type, npos>(data(), size(), __s, __pos,
                ...
                {
                    _LIBCPP_ASSERT(__s.size() == 0 || __s.data() != nullptr, "string_view::find(): received nullptr");
                    return std::__str_rfind<value_type, size_type, traits_type, npos>(data(), size(), __s.data(), __pos,
                                                                                      __s.size());
                }
                ...
                rfind(const _CharT *__s, size_type __pos = npos) const
                {
                    ...
                    return std::__str_rfind<value_type, size_type, traits_type, npos>(data(), size(), __s, __pos,
                                                                                      traits_type::length(__s));
                }
                ...
                find_first_of(const _CharT *__s, size_type __pos, size_type __n) const
                {
                    ...
                    return std::__str_find_first_of<value_type, size_type, traits_type, npos>(data(), size(), __s,
                                                                                              __pos, __n);
                }
                ...
                find_last_of(basic_string_view __s, size_type __pos = npos) const _NOEXCEPT
                {
                    ...
                    return std::__str_find_last_of<value_type, size_type, traits_type, npos>(data(), size(), __s.data(),
                                                                                             __pos, __s.size());
                }
                ...
                find_last_of(const _CharT *__s, size_type __pos, size_type __n) const
                {
                    ...
                    return std::__str_find_last_of<value_type, size_type, traits_type, npos>(data(), size(), __s, __pos,
                                                                                             __n);
                }
                ...
                {
                    return std::__str_find_first_not_of<value_type, size_type, traits_type, npos>(data(), size(), __c,
                                                                                                  __pos);
                }
                ...
                find_first_not_of(const _CharT *__s, size_type __pos, size_type __n) const
                {
                    ...
                    return std::__str_find_first_not_of<value_type, size_type, traits_type, npos>(data(), size(), __s,
                                                                                                  __pos, __n);
                }
                ...
                {
                    return std::__str_find_last_not_of<value_type, size_type, traits_type, npos>(data(), size(), __c,
                                                                                                 __pos);
                }
                ...
                find_last_not_of(const _CharT *__s, size_type __pos, size_type __n) const
                {
                    ...
                    return std::__str_find_last_not_of<value_type, size_type, traits_type, npos>(data(), size(), __s,
                                                                                                 __pos, __n);
                }
...
namespace std
{
    ...
    quoted(std::experimental::basic_string_view<_CharT, _Traits> __sv, _CharT __delim = _CharT('"'),
           _CharT __escape = _CharT('\\'))
    {
        return __quoted_output_proxy<_CharT, const _CharT *, _Traits>(__sv.data(), __sv.data() + __sv.size(), __delim,
                                                                      __escape);
    }
#endif
