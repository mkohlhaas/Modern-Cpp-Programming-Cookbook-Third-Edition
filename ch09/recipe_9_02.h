...
{
    void
    func_no_throw() noexcept
    {
    }

    template <typename T>
    T
    generic_func_1() noexcept(std::is_nothrow_constructible_v<T>)
    {
        return T{};
    }
    ...
    template <typename T>
    T
    generic_func_2() noexcept(noexcept(T{}))
    {
        return T{};
    }
    ...
    int
    double_it(int const i) noexcept
    {
        return i + i;
    }
    ...
    execute()
    {
        std::cout << std::boolalpha << noexcept(func_no_throw()) << '\n' // true
