...
namespace recipe_9_12
{
    ...
    class project_t : public cost_unit_t
    {
      ...
      public:
        bool
        operator==(project_t const &other) const noexcept
        {
            return (cost_unit_t &)(*this) == (cost_unit_t &)other && name == other.name && type == other.type &&
                   id == other.id;
        }
        ...
        operator<=>(project_t const &other) const noexcept
        {
            ...
            if (auto cmp = (cost_unit_t &)(*this) <=> (cost_unit_t &)other; cmp != 0)
            {
                return cmp;
            }
    ...
    struct employee_t
    {
        ...
        bool
        operator==(employee_t const &other) const
        {
            return is_same(other);
        }

        std::partial_ordering
        operator<=>(employee_t const &other) const noexcept
        {
            if (is_same(other))
            {
    ...
    struct ipv4
    {
        explicit ipv4(unsigned char const a = 0, unsigned char const b = 0, unsigned char const c = 0,
