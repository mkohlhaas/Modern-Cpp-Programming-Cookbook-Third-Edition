...
namespace recipe_9_11
{
    ...
    void
    Master::take_apprentice(std::shared_ptr<Apprentice> a)
    {
        apprentice = a;
    ...
    void
    Apprentice::take_master(std::weak_ptr<Master> m)
    {
        master = m;
    }
    ...
    execute()
    {
        ...
        // arrays
        {
            ...
            std::shared_ptr<int> pa2(new int[3]{1, 2, 3}, [](int *p) { delete[] p; });
        }
