...
namespace recipe_9_03
{
    ...
    session
    connect(std::string const &uri, int const timeout = 2000)
    {
        /* do something */
        return session{/* ... */};
    }
    ...
    {
        double
        compute_value(double const input) const
        {
      ...
      public:
        double
        compute(double const input) const
        {
