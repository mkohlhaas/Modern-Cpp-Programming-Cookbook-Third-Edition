...
namespace recipe_9_04
{
    ...
    execute()
    {
...

        {
            try
            {
                [[maybe_unused]] int a = factorial2(5);
                [[maybe_unused]] int b = factorial2(-5);
            }
            ...
            [[maybe_unused]] constexpr int c = factorial2(5);
            //[[maybe_unused]] constexpr int d = factorial2(-5); // error
        }
    }
} // namespace recipe_9_04